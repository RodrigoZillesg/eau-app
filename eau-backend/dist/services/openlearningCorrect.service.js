...
exports.openLearningCorrectService = exports.OpenLearningCorrectService = void 0;
 ...
 */
class OpenLearningCorrectService {
    axiosInstance;
    config;
    constructor() {
     ...
     */
    async provisionUser(memberId, userData) {
        try {
     ...
     */
    async generateSSOLaunchUrl(memberId, openLearningUserId, classId) {
        try {
...
exports.OpenLearningCorrectService = OpenLearningCorrectService;
exports.openLearningCorrectService = new OpenLearningCorrectService();
//# sourceMappingURL=openlearningCorrect.service.js.map