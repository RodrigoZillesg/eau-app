...
-- Copie tudo de uma vez e cole no SQL Editor, depois clique RUN
-- ===================================================================
...
-- Criar tabela de configurações por categoria
CREATE TABLE cpd_category_settings (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
...
-- Inserir configurações das categorias
...
SELECT 'Settings created:' as info, COUNT(*) as count FROM cpd_settings;
SELECT 'Categories created:' as info, COUNT(*) as count FROM cpd_category_settings;