-- SQL corrigido para corrigir usuário existente sem permissões
...
-- 3. Verificar resultado (GROUP BY corrigido)
SELECT 
    u.email,
    u.created_at,
    m.first_name,
...
GROUP BY u.email, u.created_at, m.first_name, m.last_name, m.membership_status
