...
-- VERSÃO CORRIGIDA: usa campos existentes na tabela members
...
INSERT INTO members (
    ...
    phone, 
    company_name, 
    street_address,  -- mudado de 'address' para 'street_address'
    suburb,          -- campo correto ao invés de 'city'
    state, 
    postcode,        -- mudado de 'postal_code' para 'postcode'
    country, 
    membership_type, 
    membership_status
)
...
-- Verificar se os membros foram inseridos
SELECT 
    first_name, 
    last_name, 
    email, 
